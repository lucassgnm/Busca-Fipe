...
-- Copiando estrutura do banco de dados para buscafipe
CREATE DATABASE IF NOT EXISTS `buscafipe` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `buscafipe`;

-- Copiando estrutura para tabela buscafipe.opinioes
CREATE TABLE IF NOT EXISTS `opinioes` (
  ...
  `notageral` decimal(10,2) DEFAULT NULL,
  `ptspositivos` varchar(255) DEFAULT NULL,
  `ptsnegativos` varchar(255) DEFAULT NULL,
  `defapr` varchar(255) DEFAULT NULL,
  `tipoveiculo` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela buscafipe.opinioes: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `opinioes` DISABLE KEYS */;
INSERT INTO `opinioes` (`id`, `email`, `marca`, `modelo`, `ano`, `notageral`, `ptspositivos`, `ptsnegativos`, `defapr`, `tipoveiculo`) VALUES
	(7, 'lucasgnm@gmail.com', 'Alfa Romeo', '145 Quadrifoglio 2.0', '1997 Gasolina', 5.00, 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 1),
	(8, 'lucasgnm@gmail.com', 'ATALA', 'SKEGIA 50cc', '2001', 2.00, 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 0),
	(9, 'lucasgnm@gmail.com', 'NEOBUS', 'THUNDER + EXECUTIVO 1p (diesel)', '2008', 3.50, 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 2),
	(10, 'lucasgnm@gmail.com', 'Alfa Romeo', '145 Quadrifoglio 2.0', '1997 Gasolina', 2.50, 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 1),
	(11, 'lucasgnm@gmail.com', 'CHANGAN', 'MINI STAR Family 1.0 8V 53cv (MiniVan)', '2012 Gasolina', 3.50, 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 'Nunc pharetra semper justo, ut vulputate massa congue non. Morbi dictum quis odio eget dignissim. Nunc feugiat tellus in aliquam eleifend. ', 1),
	(14, 'lucasgnm@gmail.com', 'HARLEY-DAVIDSON', 'ELECTRA GLIDE FLHT', '2001', 4.50, 'teste', 'teste', 'teste', 0);
/*!40000 ALTER TABLE `opinioes` ENABLE KEYS */;

-- Copiando estrutura para tabela buscafipe.pais
...
-- Copiando dados para a tabela buscafipe.pais: 254 rows
...
-- Copiando estrutura para tabela buscafipe.tipos_auto
CREATE TABLE IF NOT EXISTS `tipos_auto` (
  `id` int(11) NOT NULL,
  `descricao` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela buscafipe.tipos_auto: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tipos_auto` DISABLE KEYS */;
INSERT INTO `tipos_auto` (`id`, `descricao`) VALUES
	(0, 'Moto'),
	(1, 'Carro'),
	(2, 'Caminão');
/*!40000 ALTER TABLE `tipos_auto` ENABLE KEYS */;

-- Copiando estrutura para tabela buscafipe.usuarios
...
-- Copiando dados para a tabela buscafipe.usuarios: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `email`, `senha`, `pais`) VALUES
	(10, 'lucasgnm@gmail.com', 'ebdf496f67651cddf6aaa1f0b130f1b99ce9e2e93dc2503d926edcff15aee668', 1);
